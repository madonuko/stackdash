...
CREATE TABLE "ipam_allocations" (
	...
	"opnsense_subnet_uuid" text,
	"opnsense_reservation_uuid" text,
...
CREATE UNIQUE INDEX "ipam_allocations_vm_family_index" ON "ipam_allocations" USING btree ("associated_vm_id","family");--> statement-breakpoint
