	...
	<div class="w-full max-w-xs">
		...
		<div class="space-y-4">
			...
			<form onsubmit={(e) => { e.preventDefault(); handleSignup(); }} class="space-y-3">
				...
				<Button type="submit" class="w-full" disabled={loading || (!!confirm && password !== confirm)}>
					{#if loading}
			...
			<p class="text-center text-xs text-fyra-gray-500">
				Already have an account? <a href="/login" class="text-fyra-red-400 hover:text-fyra-red-300">Sign in</a>
			</p>
		</div>
	</div>
</div>
