...
export function getRuntimeEnv(): RuntimeEnv {
	...
	if (platformEnv) {
		return {
			...
			NETBOX_IPV4_PREFIX_ID: platformEnv.NETBOX_IPV4_PREFIX_ID,
			NETBOX_IPV6_PREFIX_ID: platformEnv.NETBOX_IPV6_PREFIX_ID,
			NETBOX_IPV6_PREFIX_LENGTH: platformEnv.NETBOX_IPV6_PREFIX_LENGTH,
	...
	return {
		...
		NETBOX_IPV4_PREFIX_ID: privateEnv.NETBOX_IPV4_PREFIX_ID,
		NETBOX_IPV6_PREFIX_ID: privateEnv.NETBOX_IPV6_PREFIX_ID,
		NETBOX_IPV6_PREFIX_LENGTH: privateEnv.NETBOX_IPV6_PREFIX_LENGTH,
		OPNSENSE_API_KEY: privateEnv.OPENSENSE_API_KEY,
		OPNSENSE_API_SECRET: privateEnv.OPENSENSE_API_SECRET,
